...
#
# Generated by Vivado on Fri May 17 13:26:20 -0400 2019
...
# Script info
echo -e "clk_wiz.sh - Script generated by export_simulation (Vivado v2016.3 (64-bit)-id)\n"
...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot clk_wiz xil_defaultlib.clk_wiz xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim clk_wiz -key {Behavioral:sim_1:Functional:clk_wiz} -tclbatch cmd.tcl -log simulate.log
}
